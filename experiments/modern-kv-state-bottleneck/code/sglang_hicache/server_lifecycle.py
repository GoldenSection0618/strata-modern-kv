"""SGLang server lifecycle for a full Slurm job.
...
DEFAULT_READY_TIMEOUT_S = 900.0   # model load on A100 can take several minutes
...
#: experiment package is ``sglang_hicache`` precisely so that
